...
public class WebPageFetchInteractor extends Port<WebPageFetchInput, WebPageFetchOutput> implements WebPageFetchPort {

    private final WebPageRepository webPageRepository;

    @Override
    protected WebPageFetchOutput handle(WebPageFetchInput input) {
